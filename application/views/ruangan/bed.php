            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Daftar Bed</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                foreach ($bed as $pr) : ?>
                                    <tr>
                                        ...
                                        <td><?= $pr['bed_nama']; ?></td>
                                        <td>
                                            <?php if ($pr['bed_tersedia'] == '1') { ?>
                                                <a class="d-block"><?= $pr['us_nama'] ?></a><span class="right badge badge-success">Kosong</span>
                                            <?php } else if ($pr['bed_tersedia'] == '0') { ?>
                                                <a class="d-block"><?= $pr['us_nama'] ?></a><span class="right badge badge-danger">Terisi</span>
                                            <?php } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php $ambil = $this->db->get_where('t_bed', ['bed_id' => $pr['bed_id']])->row_array();
                                            if ($ambil) {
                                            } else { ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?php echo base_url('ruangan/bedadd'); ?>" method="post">
                            <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" style="display: none">
                            <div class="form-group">
                                ...
                                <select name="kamar" class="form-control" required>
                                    ...
                                    <?php foreach ($kamar as $k) : ?>
                                        <option value="<?= $k['kamar_id'] ?>"><?= $k['klp_nama'] . ' : ' . $k['kamar_nama'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama / Nomor Bed</label>
