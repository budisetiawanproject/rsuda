                                ...
                                <tbody>
                                    ...
                                    foreach ($slide as $pr) : ?>
                                        <tr>
                                            ...
                                            <td><?= $pr['judul']; ?></td>
                                            <td><?= $pr['keterangan']; ?></td>
                                            <td style="width: 50px;"><img width="90%" src="img/upload_destinasi_wisata/<?= $pr['gambar']; ?>"></td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLongTitle">Tambah Destinasi Wisata</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('wisata/tambah'); ?>">
                            ...
                            <div class="row col-md-12">
                                <section class="content">
                                    <div class="row">
                                        <div class="card-body pad">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Nama Tempat Wisata 100 Karakter</label>
                                                <textarea name="tempat" class="form-control" maxlength="100" required></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Gambar Harus Portrait</label>
