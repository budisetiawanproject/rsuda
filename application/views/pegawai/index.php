            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a style="color: white;" href="<?= base_url('pegawai/tambah') ?>" type="button" class="btn btn-sm btn-primary" data-target="#tipe">Tambah Pegawai</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" action="<?= base_url('pegawai/useradd'); ?>" enctype="multipart/form-data">
                                                        <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" style="display: none">
                                                        <label>NIK</label>
                                                        <input name="id" class="form-control" type="hidden" value="<?= $pr['peg_id']; ?>">
                                                        <input name="nik" class="form-control" type="text" value="<?= $pr['peg_nik']; ?>" readonly required>
                                                        <label>Nama Lengkap</label>
                                                        <input name="nama" class="form-control" type="text" value="<?= $pr['peg_gelar_depan'] . ' ' . $pr['peg_nama'] . ' ' . $pr['peg_gelar_belakang']; ?>" readonly>
                                                        <label>Akses</label>
