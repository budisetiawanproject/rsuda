...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Registrasi Pasien Rawat Jalan</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Registrasi Pasien Rawat Jalan</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Daftar Registrasi Pasien Jalan</h3>
                    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($regis as $pr) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($pr['pas_ket'] == '') { ?>
                                                <button class="btn btn-primary btn-sm mr-1" type="button" data-toggle="modal" data-target=".bd-example-modal-lg-<?= $pr['role_id']; ?>"><i class="fas fa-stethoscope"></i></button>
                                            <?php } ?>
                                        </td>
                                    </tr>
