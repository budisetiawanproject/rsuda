                        ...
                        <div class="card-body">
                            ...
                            <?php if ($session == 1 || $session == 2) { ?>
                                <div>
                                    ...
                                    <div class="card-body">
                                        <form role="form" method="POST" action="<?= base_url('pendaftaran/addpasien'); ?>" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <table class="table col-12" border="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control" maxlength="16" name="nik" value="<?= set_value('nama') ?>">
                                                                    <?= form_error('nama', '<small class="text-danger">', '</small>') ?>
                                                                </td>
                                                                <td>
                                                                    Nama Ibu Kandung
